...
const PatchProductModal = ({ isOpen, onClose, categoryId, onProductUpdate }) => {
  ...
  return (
    <>
            ...
            {isLoading ? (
              ...
              <Box w="100%" maxW="600px" mx="auto" my="auto" mt="3" mb="10">
                <form onSubmit={formik.handleSubmit} style={{ margin: "auto", width: "100%" }}>
                  ...
                  <Button onClick={openChangeImageModal}>Change Product Image</Button>
      ...
      <ChangeProductImage isOpen={isChangeImageModalOpen} onClose={closeChangeImageModal} categoryId={categoryId} onProductUpdate={onProductUpdate} />
    </>
  );
};
