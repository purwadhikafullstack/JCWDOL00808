    ...
    <div className="container mx-auto px-4 mb-3">
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} size="6xl">
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Box maxWidth="auto" mx="auto" mt="8" maxHeight="70vh" overflowY="auto" width="100%">
              ...
              <Box>
                ...
                {allData.payment_proof === null || allData.status === "Previous payment proof rejected" ? (
                  <>
          ...
          <ModalFooter>
            {allData.status === "Canceled" || allData.status === "Waiting for confirmation" || allData.status === "Shipped" || allData.status === "Order confirmed" || allData.status === "Previous payment proof rejected" ? null : (
              <>
                <Flex mt={3}>
                  <SendOrderModal orders_id={allData.id} orders_status={allData.status} func={getOrders} onClose={() => setIsModalOpen(false)} />
                  <Button
                    mr={2}
                    _hover={{ bg: "red.600" }}
                    colorScheme="red"
                ...
                <AlertDialog isOpen={isAlertOpen} leastDestructiveRef={cancelRef} onClose={onAlertClose}>
                  <AlertDialogOverlay>
                    <AlertDialogContent>
                      ...
                      <AlertDialogBody>Are you sure cancelling this order? This action can't be undone.</AlertDialogBody>
