...
const ManageAdmin = () => {
  ...
  const getUsers = async () => {
    const response = await axios.get(
      `http://localhost:8000/admin/getAdmin?search_query=${keyword}&page=${page}&limit=${limit}`,
      {
        params: {
          sort,
          order,
      ...
      <div class="grid grid-cols-5 md:grid-cols-1">
        <div class="mx-4">
          <form onSubmit={searchData}>
            <div class="flex justify-center my-2">
              <div class="relative mr-2">
                <input
                  type="text"
                  class="h-10 w-96 pl-3 pr-8 rounded-lg z-0 border-2 focus:shadow focus:outline-none"
                  value={query}
                ...
                <div class=" top-0 right-0 mt-3 mr-2">
                  <button
                    type="submit"
                    class="bg-dark-purple hover:bg-blue-700 text-white font-bold  py-2 px-4 rounded">
                    Search
                  </button>
                </div>
              </div>
          ...
          <div className="flex items-center justify-between mb-4 md:mb-0">
            <div className="flex items-center">
              ...
              <select
                ...
                className="border border-gray-400 p-2 rounded-lg mr-20">
          ...
          <nav
            ...
            />
            <Link to="/admin">
              <button class="bg-dark-purple hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Back
              </button>
            </Link>
          </nav>
