...
route.post(
  ...
  warehousesController.addWarehouseProduct
);
route.get(
  "/get-warehouse-product/:id",
  warehousesController.getWarehouseProduct
);
route.patch(
  "/update-stock-product/:id",
  warehousesController.updateWarehouseProduct
);
route.get(
  "/get-warehouse-product/:id",
  warehousesController.getWarehouseProductById
);
route.delete(
  "/delete-warehouse-product/:id",
  warehousesController.deleteWarehouseProduct
);
route.get(
  "/warehouse-id-by-admins-id",
  verifyToken,
