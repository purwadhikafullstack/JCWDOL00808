...
const { usersRouter, authRouter, adminsRouter, warehousesRouter, adminRouter, productRouter, productCategoryRouter } = require("./routers"); //refer to index.js in routers folder
