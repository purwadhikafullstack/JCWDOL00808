...
const { usersRouter, authRouter, adminsRouter, warehousesRouter, adminRouter, productsRouter, productRouter } = require("./routers"); //refer to index.js in routers folder
